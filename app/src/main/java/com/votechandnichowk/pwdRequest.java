...
public class pwdRequest extends AsyncTask<String, Void, String> {
    Context context;
    public pwdRequest(Context context){
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            String link="http://avrutti.com/election/eci/pwd_request.php";
